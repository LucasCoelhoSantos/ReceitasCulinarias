...
using Desafio.Application.Autenticacao.DTOs;
using Desafio.Application.Autenticacao.Interfaces;
...
public class AuthController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(IEnumerable<object>), StatusCodes.Status400BadRequest)] // Para erros de IdentityResult
